...
import com.bagus.dynamicrecyclerview.R
...
fun View.learAapplyStrokedBackground(backgroundColor: Int, strokeColor: Int = 0, alpha: Float = 1.0f, strokeWidth: Int = 5) {
    ...
    drawable.setColor(customAdjustAlpha(backgroundColor, alpha))
}
fun customAdjustAlpha(color: Int, factor: Float): Int {
...
fun Context.customAppColor(color: Int): Int {
